...
def parse_arguments(input_args):
    ...
    parser.add_argument(
        ...
        "--input-dir",
        type=str,
        default='data/ROBO/controllers/bc/controller/',
    ...
    parser.add_argument(
        ...
        "--traj-dir",
        type=str,
        default='data/ROBO/target_trajectories/',
...
if __name__ == "__main__":
    ...
    result = run_robo_controller(sys.argv[1:])
    with open('results/rs_linear', 'wb') as f:
