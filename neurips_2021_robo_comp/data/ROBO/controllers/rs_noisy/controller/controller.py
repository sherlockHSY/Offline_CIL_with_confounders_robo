...
class controller(object):
    def __init__(self, system, d_control):
        ...
        if system.endswith("beetle") or system.endswith("butterfly") or system.endswith("bumblebee"):  # if polynomial cliping
    ...
    def get_input(self, state, position, target):
        ...
        """ 
        if self.system.endswith("beetle") or self.system.endswith("butterfly") or self.system.endswith("bumblebee"):
